...
const Logo = () => (
    <svg width="40" height="40" viewBox="0 0 100 100" className="text-[#00A9FF]" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-start">
            ...
            <div className="flex space-x-4 mt-4">
              <a href="mailto:contact@kallamino.org" className="text-gray-500 hover:text-[#00A9FF]"><Mail size={20} /></a>
              <a href="#" className="text-gray-500 hover:text-[#00A9FF]"><Send size={20} /></a>
            </div>
          </div>
