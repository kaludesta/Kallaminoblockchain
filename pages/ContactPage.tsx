                ...
                <div className="space-y-6">
                    <div className="flex items-start gap-4 p-4 rounded-lg">
                        ...
                        <div>
                            ...
                            <a href="mailto:contact@kallamino.org" className="text-[#007bff] hover:underline">contact@kallamino.org</a>
                        </div>
                    </div>
                     <div className="flex items-start gap-4 p-4 rounded-lg">
                        ...
                        <div>
                            ...
                            <a href="#" className="text-[#007bff] hover:underline">t.me/kallaminobc</a>
                        </div>
                    </div>
                     <div className="flex items-start gap-4 p-4 rounded-lg">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-300">High School Auditorium, 123 Tech Avenue</p>
